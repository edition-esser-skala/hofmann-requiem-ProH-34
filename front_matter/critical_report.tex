...
\directlua{
scores = {
  ottoni = "Clarino I, II con sordino in C\string\\newline Timpani in C–G",
  trb1 = "Trombone I",
  trb2 = "Trombone II",
  vl1 = "Violino I",
  vl2 = "Violino II",
...
\scoring{S, A, T, B (coro), 2 clno (C), 2 trb, [timp (C–G)], 2 vl, 2 vla, b, org}
\repository{edition-esser-skala/hofmann-requiem-ProH-34}
\version{1.4.0}
\date{2021-11-04}
\maketitle
...
Music engraving by LilyPond 2.22.0 (\url{https://www.lilypond.org}).\\
...
This edition bases upon a copy in the Austrian National Library. The digital version of the manuscript is available at \url{https://data.onb.ac.at/rec/AC14273847} (siglum F.24.St.Peter.A420; no RISM entry).
...
\begin{longtable}{lll L{10cm}}
  ...
  2 & 44  & trb 2 & 3rd half note in Ms: d′2 \\
  ...
  6 & 11  & trb 1 & 4th eighth in Ms: f′8 \\
  \bottomrule
\end{longtable}
